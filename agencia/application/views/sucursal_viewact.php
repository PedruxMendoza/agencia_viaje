...
<html lang="en">
<head>
	<title>Travelocity - Agencia | Actualizar</title>
	<meta charset="utf-8">
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
				<div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
					<p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo base_url('Welcome/index') ?>">Inicio</a></span> <span class="mr-2"><a href="<?php echo base_url('sucursal_controller/index') ?>">Agencia</a></span> <span>Actualizar</span></p>
	...
	<section class="ftco-section contact-section ftco-degree-bg">
		<div class="container">
			<?php foreach ($agencia as $su) { ?>
				<form action="<?php echo base_url('sucursal_controller/actualizar') ?>" method="POST">
					<input type="hidden" name="id" value="<?= $su->id_agencia ?>">
					<div class="container">
						<div class="row">
							<div class="col-md-12"><h1 class="bg-dark text-white text-center">ACTUALIZAR SUCURSAL</h1></div>
						</div>
						<br>
						...
						<div class="row">
							...
							<div class="col-md-3"><input type="text" maxlength="50" name="nombre" required="" value="<?= $su->nombre_agencia ?>" class="form-control"></div>
							<div class="col-md-3"></div>
						</div>
						<div class="row">
							<div class="col-md-3"></div>
							<div class="col-md-3" align="left">Teléfono</div>
							<div class="col-md-3"><input type="text" name="telefono"  required="" maxlength="8" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" value="<?= $su->telefono ?>" class="form-control"></div>
							<div class="col-md-3"></div>
						</div>
						<div class="row">
							<div class="col-md-3"></div>
							...
							<div class="col-md-3"><select name="departamento" required="" class="form-control">
								...
								<?php foreach ($departamento as $de) { ?>
									<option value="<?= $de->id_departamento ?>" <?php if ($de->id_departamento== $su->id_departamento) { echo "selected"; } ?>><?= $de->nombre_departamento ?></option>
								<?php } ?>
							</select></div>
							<div class="col-md-3"></div>
