...
<html lang="en">
<head>
  <title>Travelocity - Aeropuerto | Actualizar</title>
  <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo base_url('Welcome/index') ?>">Inicio</a></span> <span class="mr-2"><a href=""<?php echo base_url('aeropuerto_controller/index') ?>"">Aeropuerto</a></span> <span>Actualizar</span></p>
  ...
  <section class="ftco-section contact-section ftco-degree-bg">
    <div class="container">
      <form action="<?php echo base_url("aeropuerto_controller/actualizar")?>" method="POST">
        <div class="row">
          <div class="col-md-12"><h1 class="bg-dark text-white text-center">ACTUALIZAR AEROPUERTO</h1></div>
        </div>
        <?php foreach ($aeropuerto as $a) { ?>
          <input type="hidden" name="id" value="<?= $a->id_aeropuerto ?>">
          <br>
          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-3" align="left">Nombre de aeropuerto</div>
            <div class="col-md-3"><input type="text" name="nombre_aeropuerto" maxlength="50" class="form-control" required="" value="<?= $a->nombre_aeropuerto ?>"></div>
            <div class="col-md-3"></div>    
          </div>
          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-3" align="left">Dirección</div>
            <div class="col-md-3"><input type="text" name="direccion" maxlength="50" required="" value="<?= $a->direccion ?>" class="form-control"></div>
            <div class="col-md-3"></div>    
          </div>
          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-3" align="left">Teléfono</div>
            <div class="col-md-3"><input type="number" name="telefono" maxlength="8" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required="" value="<?= $a->telefono ?>" class="form-control"></div>
            <div class="col-md-3"></div>    
          </div>
          <br>
          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6"><input type="submit" name="action" class="btn btn-block btn-success" value="Actualizar"></div>
            <div class="col-md-3"></div>    
          </div>
