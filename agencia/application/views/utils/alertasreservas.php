	...
	if($msj=='success') { ?>
		<script>
			Swal.fire({
				...
				if (result.value) {
					window.location.href = "../reserva_controller/index" ; /*Aqui se cambia por el nombre del controlado que se ira a copiar (../nombre_controller/index)*/
				}
			})
		</script>
	<?php } 
	...
	if ($msj=='cancel') { ?>
		<script>
			Swal.fire({
				...
				text: "Se ha cancelado correctamente la reserva",
				icon: 'success',
				showCancelButton: false,
				confirmButtonColor: '#3085d6',
				confirmButtonText: 'Aceptar'
	...
	if ($msj=='repro') { ?>
		<script>
			Swal.fire({
				...
				text: "Se ha reprogramado correctamente la reserva",
				icon: 'success',
				showCancelButton: false,
				confirmButtonColor: '#3085d6',
				confirmButtonText: 'Aceptar'
...
<script>
	function alerta_eliminar(id){
		Swal.fire({
			...
			if (result.value) {
				window.location.href = "../reserva_controller/eliminar/"+id;
			}
		})
	}
</script>