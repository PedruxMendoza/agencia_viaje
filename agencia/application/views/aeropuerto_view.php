...
<html lang="en">
<head>
  <title>Travelocity - Aeropuerto</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo base_url("props/images/aero2.jpg") ?>');">
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          ...
          <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Aeropuerto</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section contact-section ftco-degree-bg">
   <div class="container">
    <div class="container">
      <form action="<?php echo base_url("aeropuerto_controller/ingresar")?>" method="POST">

        <div class="row">
          <div class="col-md-12">
            <h1 class="bg-dark text-white text-center">INGRESAR AEROPUERTO</h1>
          </div>
        </div>
        <br>
        ...
        <div class="row">
          ...
          <div class="col-md-3"><input type="text" name="nombre_aeropuerto" maxlength="50" required placeholder="Escriba aeropuerto" class="form-control"></div>
          <div class="col-md-3"></div>
        </div>
        <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-3" align="left">Dirección</div>
          <div class="col-md-3"><input type="text" name="direccion" maxlength="50" required placeholder="Escriba direccion" class="form-control"></div>
          <div class="col-md-3"></div>
        </div>
        <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-3" align="left">teléfono</div>
          <div class="col-md-3"><input type="number" name="telefono" maxlength="8" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" required placeholder="digite el telefono" class="form-control"></div>
          <div class="col-md-3"></div>
        </div>
        <br>
        <div class="row">
      ...
      <div class="row">
        <div class="col-md-12">
          <h1 class="bg-dark text-white text-center">DATOS DE AEROPUERTO</h1>
        </div>
      </div>  
      <table border class="table table-dark" id="aero">
        <thead>
          <tr>
        ...
        <tbody>
          <?php foreach ($aeropuerto as $a) { ?>
            <tr>
              <td><?= $a->nombre_aeropuerto?></td>
              <td><?= $a->direccion?></td>
              <td><?= $a->telefono?></td>
              <td><a onclick="alerta_eliminar(<?= $a->id_aeropuerto ?>)" class="btn btn-block btn-danger"><i class="fas fa-trash-alt"></i></a></td>
              <td><a href="<?php echo base_url("aeropuerto_controller/get_datos/".$a->id_aeropuerto)?>" class="btn btn-block btn-info"><i class="far fa-edit"></i></a></td>
            </tr>
          <?php } ?>
        </tbody>
      </table>
...
<?php $this->load->view('utils/alertasaeropuerto') ?>
