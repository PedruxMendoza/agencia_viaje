...
<html lang="en">
<head>
  <title>Travelocity - Origen | Actualizar</title>
  <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo base_url('Welcome/index') ?>">Inicio</a></span> <span class="mr-2"><a href="<?php echo base_url('origen_controller/index') ?>">Origen</a></span> <span>Actualizar</span></p>
  ...
  <section class="ftco-section contact-section ftco-degree-bg">
    <div = class="container">
      <?php foreach ($origen as $valor) { ?>
        <form action="<?php echo base_url("origen_controller/actualizar")?>" method="POST">
          <input type="hidden" name="id" value="<?= $valor->id_origen?>">
          <div class="row">
            <div class="col-md-12"><h1 class="bg-dark text-white text-center">ACTUALIZAR PUNTO DE ORIGEN</h1></div>
          </div>
          <br>
          <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-3" align="left">Nombre de ciudad</div>
            <div class="col-md-3"><input type="text" name="nombre_ciudad" maxlength="50" required="" value="<?= $valor->nombre_origen?>" class="form-control"></div>
            <div class="col-md-3"></div>    
          </div>
          <div class="row">
            <div class="col-md-3"></div>
