...
<html lang="en">
<head>
  <title>Travelocity - Origen</title>
  <meta charset="utf-8">
...
<body>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo base_url("props/images/bg_8.jpg") ?>');">
    <div class="overlay"></div>
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="<?php echo base_url('Welcome/index') ?>">Inicio</a></span> <span>Origen</span></p>
          <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Origen</h1>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="ftco-section contact-section ftco-degree-bg">
    <div class="container">
      <form action="<?php echo base_url("origen_controller/insertar")?>" method="POST">
        <div class="row">
          <div class="col-md-12"><h1 class="bg-dark text-white text-center">INGRESAR PUNTO DE ORIGEN</h1></div>
        </div>
        <br>
        ...
        <div class="row">
          ...
          <div class="col-md-3"><input type="text" name="nombre_ciudad" maxlength="50" class="form-control" placeholder="Digite nombre de ciudad"></div>
        ...
        <div class="row">
          <div class="col-md-12">
            <h1 class="bg-dark text-white text-center">DATOS DE ORIGEN</h1>
          </div>
        </div>  
        <table class="table table-dark" id="origin">
          <thead>
            <tr>
          ...
          <tbody>
            <?php foreach ($origen as $d) { ?>
              <tr>
                <td><?= $d->nombre_origen ?></td>
                <td><?= $d->nombre_pais ?></td>
                <td><a onclick="alerta_eliminar(<?= $d->id_origen ?>)" class="btn btn-block btn-danger"><i class="fas fa-trash-alt"></i></a></td>
                <td><a class="btn btn-block btn-info" href="<?php echo base_url("origen_controller/get_datos/".$d->id_origen)?>"><i class="far fa-edit"></i></a></td>
...
<?php $this->load->view('utils/alertasorigen') ?>
